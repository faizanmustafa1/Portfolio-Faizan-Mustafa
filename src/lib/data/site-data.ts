...
export const skillCategories = [
  ...
  },
  {
    title: "SEO",
    skills: [
      { name: "Technical SEO", icon: "seo" },
      { name: "On-page SEO", icon: "seo" },
      { name: "Off-page SEO", icon: "seo" },
      { name: "Google Search Console", icon: "analytics" },
      { name: "Google Analytics", icon: "analytics" },
      { name: "Core Web Vitals", icon: "performance" },
    ],
  },
] as const;
